...
%%  Hydraulic analysis using epanet2d.exe binary file.(This function ignores events)
...
time_2 = toc;
%% Hydraulic analysis using ENepanet binary file (fastest). (This function ignores events)
